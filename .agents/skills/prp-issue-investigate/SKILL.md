...
description: Investigate a GitHub issue or problem - analyze codebase, create plan, post to GitHub. Use when a developer needs to research and document a bug, feature request, or problem before implementing a fix. Accepts a GitHub issue number, URL, or free-form description.
---

# Investigate Issue

**Input**: The issue number, URL, or problem description from the developer's request
