---
name: prp-plan
description: Create comprehensive feature implementation plan with codebase analysis and research. Use when a developer wants to plan implementation of a feature or when given a PRD file path. Accepts a feature description or path to a .prd.md file.
---

<objective>
Transform the feature description or PRD path from the developer's request into a battle-tested implementation plan through systematic codebase exploration, pattern extraction, and strategic research.
...
**CRITICAL: Launch two specialized agents in parallel.**
...
**For complex features with multiple integration points**, use `$codebase-analyst` to trace how existing architecture works at the integration points identified in Phase 2:
