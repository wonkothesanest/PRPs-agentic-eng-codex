---
name: prp-prd
description: Interactive PRD generator - problem-first, hypothesis-driven product spec. Use when a developer wants to create a Product Requirements Document for a feature or product. Accepts a feature/product idea or starts with questions if none provided.
---

# Product Requirements Document Generator

**Input**: The feature/product idea from the developer's request (blank = start with questions)
...
**If codebase exists, use the `$codebase-explorer` skill with the following prompt:**
...
**If no codebase, use the `$web-researcher` skill with the following prompt:**
